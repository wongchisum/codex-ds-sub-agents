[English](../PROMPT_INSTALLATION.md) · 简体中文
...
2. 阅读 README.zh-CN.md、docs/zh-CN/README.md、docs/zh-CN/INSTALLATION.md、docs/zh-CN/CONFIGURATION.md 和 docs/zh-CN/MIGRATION.md。
3. 先检查是否安装过旧的 deepseek-delegation 或 codex-custom-agents。如果存在，使用项目迁移脚本预览；保留用户修改过的文件，不得直接递归删除旧 skill 目录。
