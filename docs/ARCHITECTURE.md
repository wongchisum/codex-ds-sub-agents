...
| `skills/codex-custom-agents/scripts/claim_task.py` | 原子领取、完成、失败、定位和恢复任务 |
| `skills/codex-custom-agents/scripts/platform_lock.py` | POSIX fcntl / Windows msvcrt 字节范围文件锁抽象 |
