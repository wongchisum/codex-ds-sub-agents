...
def _minimal_install(project_root: Path, home: Path) -> None:
    ...
    shutil.copytree(project_root / "skills" / "codex-custom-agents", home / "skills" / "codex-custom-agents")
...
def main() -> int:
    ...
    skill = codex_home / "skills" / "codex-custom-agents" / "SKILL.md"
    claim = codex_home / "skills" / "codex-custom-agents" / "scripts" / "claim_task.py"
    config = codex_home / "config.toml"
